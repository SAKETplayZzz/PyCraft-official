...
class Mining_system:
    def __init__(this, _subject, _camera, _subsets):
        ...
        this.blockTypes = []
        #  Stone - 0
        this.blockTypes.append('grass_block.png')
        # Grass - 1
        this.blockTypes.append('brick_block.png')
        # Soil - 2
        this.blockTypes.append('dirt_block.png')
        # Ruby - 3
        this.blockTypes.append('coal_block.png')
        # Netherite - 4
        this.blockTypes.append('log_texture.png')
        # Our current block type.
        this.blockType = 1# I.e. stone.
        ...
        # including gaps.
        this.tDic = {}
        this.buildTex = this.blockTypes[this.blockType]
    ...
    def buildTool(this):
        ...
        this.bte.texture = this.blockTypes[this.blockType]
    ...
    def mineSpawn(this):
        ...
        if this.tDic.get(   'x'+str(this.bte.x)+
            ...
            e.scale *= 0.99999
            e.texture = this.blockTypes[this.blockType]
